...
{
    return [[UHFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[UHFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[UHFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[UHFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[UHFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[UHFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
...
+ (BOOL)renameItemAtPath:(NSString *)path withName:(NSString *)name error:(NSError **)error
{
    ...
    return [self moveItemAtPath:path
                         toPath:[[[self absolutePath:path] stringByDeletingLastPathComponent] stringByAppendingPathComponent:name]
                          error:error];
}
